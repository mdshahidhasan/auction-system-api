...
public interface IBidApp
{
    ...
    Task<ServiceResult<List<BidPublicReadModel>>> GetPublicBids(int productId);
    Task<ServiceResult<List<BidReadModel>>> GetBids(int productId, int requesterUserId, string? requesterRole);
}