...
public class ProductApp : IProductApp
{
    ...
    public ProductApp(IProductDataService productService, IProductPhotoDataService productPhotoService, IUnitOfWork unitOfWork, IMapper mapper)
    {
    ...
    public async Task<ServiceResult<ProductReadModel>> CreateProduct(int requesterUserId, ProductWriteModel productWriteModel)
    {
    ...
    public async Task<ServiceResult<List<ProductReadModel>>> GetUserProducts(int requesterUserId)
    {
        try
        {
    ...
    public async Task<ServiceResult> DeleteProduct(int requesterUserId, int productId)
    {
        var existingProduct = await _productService.GetProductById(productId);
        if (existingProduct is null)
        {
